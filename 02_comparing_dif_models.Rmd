...
when we add in student random effects as well, our recovery is much better (e.g. summing the fixed group effects and random item effects we get a difference of 1 for the first four items and a difference of 2 for the last item)
